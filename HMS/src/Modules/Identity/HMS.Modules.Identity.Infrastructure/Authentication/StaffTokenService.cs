    ...
    internal sealed class StaffTokenService : IStaffTokenService
    {
            ...
            DateTimeOffset currentTime)
        {
            ...
            var claims = new List<Claim>
            {
                ...
                new(JwtRegisteredClaimNames.UniqueName, staff.Email ?? staff.Username),
            ...
            foreach (var propertyUid in staff.PropertyUids.Distinct())
            {
                claims.Add(new Claim("property_uids", propertyUid.ToString()));
            }
